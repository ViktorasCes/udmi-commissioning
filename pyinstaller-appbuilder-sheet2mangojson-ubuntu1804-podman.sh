...
OUT_FILE=$OUT_DIR/sheet2mangojson-ubuntu1804
...
podman run --rm --volume $ROOT_DIR/:/src --volume $TMP_DIR:/tmp pyinstaller-builder-ubuntu-1804:latest /bin/bash /tmp/build.sh
mkdir -p $OUT_DIR
