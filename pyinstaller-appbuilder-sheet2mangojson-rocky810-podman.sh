...
OUT_FILE=$OUT_DIR/sheet2mangojson-rocky810
...
podman run --rm --volume $ROOT_DIR/:/src --volume $TMP_DIR:/tmp pyinstaller-builder-rocky-810:latest /bin/bash /tmp/build.sh
mkdir -p $OUT_DIR
