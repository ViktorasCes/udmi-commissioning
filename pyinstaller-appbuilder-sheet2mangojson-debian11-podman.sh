...
OUT_FILE=$OUT_DIR/sheet2mangojson-debian11
...
podman run --rm --volume $ROOT_DIR/:/src --volume $TMP_DIR:/tmp pyinstaller-builder-debian-11:latest /bin/bash /tmp/build.sh
mkdir -p $OUT_DIR
